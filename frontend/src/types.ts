...
export interface TrackCatalogEntry {
  ...
  // How map.png overlays behind a session's GPS trace on TrackMap — both are
  // always centered, only rotation/scale are admin-adjustable. See
  // frontend/src/trackMapDraw.ts.
